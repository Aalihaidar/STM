...
def get_train_args_parser():
    ...
    parser.add_argument('--output_dir', default= '/home/maiabboud/Documents/Master/SwinTrack/output', help='path where to save, empty for no saving')
    # parser.add_argument('--mixin_config', default= 'evaluation.yaml', type=str, action='append')
    # parser.add_argument('--video_path',default='/home/maiabboud/Documents/Master/videos/DJI_2.mp4',type=str,help = 'path to video that you what to apply tracker')
